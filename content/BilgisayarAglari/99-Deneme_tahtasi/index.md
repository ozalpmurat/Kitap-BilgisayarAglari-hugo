...
[https://github.com/KKKZOZ/hugo-admonitions](https://github.com/KKKZOZ/hugo-admonitions)
...
## Formül denemesi
math kütüphanesi. Hugo içinde çalışması için toml dosyasına ekleme yapıldı.
...
![alt](https://upload.wikimedia.org/wikipedia/commons/3/3f/JPEG_example_flower.jpg?width=80px)
...
{{< figure
  src="https://upload.wikimedia.org/wikipedia/commons/3/3f/JPEG_example_flower.jpg"
  alt="Topolojiler"
  caption="Görsel kaynağı: https://www.dnsstuff.com/what-is-network-topology"
  class="ma0 w-75"
>}}
