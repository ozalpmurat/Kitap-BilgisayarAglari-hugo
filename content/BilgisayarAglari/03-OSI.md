...
Bilgisayar ağlarının nasıl çalıştığını anlamak için kullanılır. Geliştirilen donanımlar ve yazılımların, standartlara uymasını ve dolayısıyla İnternet üzerinde sorunsuzca iletişim kurabilmesini sağlar.

![ChatGPT'den "Zihni Sinir projesi" tarzında OSI modeli katmanları](images/B03-OSI_ChatGPT.jpg)
*ChatGPT'den "Zihni Sinir projesi" tarzında OSI modeli katmanları*
...
ARPANET, Advanced Research Projects Agency Network (Gelişmiş Araştırma Projeleri Ajansı Ağı) ifadesinin kısaltmasıdır.
1960'ların sonunda ABD Savunma Bakanlığına bağlı DARPA tarafından finanse edilen bir araştırma ağıdır.

ARPANET'in ilk bağlantısı 1969 yılında kurulmuştur ve başlangıçta dört üniversite arasında çalışmıştır.

ARPANET, paket anahtarlama (packet switching) teknolojisini kullanan ilk büyük ölçekli ağlardan biri olmuş ve günümüzdeki İnternet'in temellerini oluşturmuştur. Bu nedenle ARPANET genellikle İnternet'in atası olarak kabul edilir.
![İnternet Tarihçesi](images/B03-Internet_Tarihce.png)
...
OSI 🆚 TCP/IP Modeli Karşılaştırmasıs


| Özellik              | OSI Referans Modeli                           | TCP/IP Modeli                                    |
| ----------------------- | ----------------------------------------------- | -------------------------------------------------- |
| Katman sayısı       | 7 katman                                      | 4 katman                                         |
| Amaç                 | Ağ iletişimini kavramsal olarak açıklamak | İnternet üzerinde gerçek iletişimi sağlamak |
| Kullanım             | Eğitim ve teorik model                       | Gerçek internet altyapısı                     |
| Tasarım yaklaşımı | Katmanlar daha ayrıntılıdır               | Daha sade ve pratiktir                           |
...
*Görsel kaynağı: [https://www.hbmacit.com/2020/06/12/c-ile-parite-biti-hesaplama/](https://www.hbmacit.com/2020/06/12/c-ile-parite-biti-hesaplama/)*
...
*Görsel kaynağı: [https://www.computernetworkingnotes.com/ccna-study-guide/data-encapsulation-and-de-encapsulation-explained.html](https://www.computernetworkingnotes.com/ccna-study-guide/data-encapsulation-and-de-encapsulation-explained.html)*

![Ethernet Çerçevesi Başlığı](images/B03-EthernetFrame.png)
*Görsel kaynağı: [https://en.wikipedia.org/wiki/Ethernet_frame](https://en.wikipedia.org/wiki/Ethernet_frame)*

![Veriye eklenen başlıklar](images/B03-CercevePaketSegment.gif)
*Görsel kaynağı: [http://som.csudh.edu/cis/471/hout/netech/encapsulation.htm](http://som.csudh.edu/cis/471/hout/netech/encapsulation.htm)*
...
*Görsel kaynağı: [https://www.alfanett.com.tr/modem.html](https://www.alfanett.com.tr/modem.html)*
...
*Görsel kaynağı: [https://www.scaler.com/topics/computer-network/circuit-switching-and-packet-switching/](https://www.scaler.com/topics/computer-network/circuit-switching-and-packet-switching/)*
...
*Görsel kaynağı: [https://community.spiceworks.com/t/how-to-find-ip-mac-addresses-on-cisco-ios-devices/1012165](https://community.spiceworks.com/t/how-to-find-ip-mac-addresses-on-cisco-ios-devices/1012165)*

![Windows MAC tablosu](images/B03-MAC_Tablosu_Windows.png)
*Görsel kaynağı: [https://www.geeksforgeeks.org/what-is-mac-address-table/](https://www.geeksforgeeks.org/what-is-mac-address-table/)*
...
*Görsel kaynağı: [https://www.pcmag.com/encyclopedia/term/ethernet-hub](https://www.pcmag.com/encyclopedia/term/ethernet-hub)*

### 3: Ağ Katmanı (IP)

![alt text](images/B03-IPveMAC.png)

İnternet'i dünyanın farklı yerlerindeki ağlar üzerinden erişilebilir kılan katman budur. Kaynak ve hedef olarak IP adresi kullanılır. IP yönlendirilebilir bir protokol olduğundan her türlü veri ağı üzerinden haberleşmeye olarak sağlanır. Bu katman en önemli görevi yönlendirme
işlemidir. Yönlendirme işlemi birden fazla ağ arayüzüne (network interface) sahip olan yönlendirici(router) adı verilen cihazlar tarafından yapılır. IP internetin temel protokolüdür. Yani bir PC internete bağlanacaksa IP’yi mutlaka biliyor olmalıdır.

!!! note
    Üçüncü katmanda aktarılan verinin en küçük anlamlı birimine `paket` denir.
...
*Görsel Kaynağı: [https://www.researchgate.net/publication/269810379_IPv4IPv6_Transition](https://www.researchgate.net/publication/269810379_IPv4IPv6_Transition)*

![TCP, IP ve Eth Başlıkları](images/B03-TCP_IP_Eth-Basliklari.png)
*Görsel Kaynağı: [https://infosys.beckhoff.com/english.php?content=../content/1033/bc9191/2792604555.html&id=](https://infosys.beckhoff.com/english.php?content=../content/1033/bc9191/2792604555.html&id=)*

### 4: Taşıma Katmanı
![Apartman benzetmesi](images/B03-Apartman_Benzetmesi.png)
...
![TCP ve UDP akışları](images/B03-TCPveUDP_Akislar.png)*Görsel Kaynağı: [https://www.karel.com.tr/bilgi/tcp-ve-udp-arasindaki-farklar-nedir](https://www.karel.com.tr/bilgi/tcp-ve-udp-arasindaki-farklar-nedir)*
...
*Görsel Kaynağı: [https://medium.com/@mehmet.topac/tcp-nedi%CC%87r-udp-nedi%CC%87r-farklari-nelerdi%CC%87r-6ff6a29573b7](https://medium.com/@mehmet.topac/tcp-nedi%CC%87r-udp-nedi%CC%87r-farklari-nelerdi%CC%87r-6ff6a29573b7)*

#### 3 way handshaking - 3 aşamalı el sıkışma

![TCP oturumu](images/B03-TCP_Oturumu.png)
*Görsel Kaynağı: [https://toschprod.wordpress.com/2012/01/30/osi-model-layer-4-transport/](https://toschprod.wordpress.com/2012/01/30/osi-model-layer-4-transport/)*

![TCP ve UDP komik](images/B03-TCPveUDP-Komik.png){width="400"}
*Görsel Kaynağı: [https://www.reddit.com/r/ProgrammerHumor/comments/18hkwj0/acknowledge/](https://www.reddit.com/r/ProgrammerHumor/comments/18hkwj0/acknowledge/)*
...
TCP'de üç yönlü el sıkışma (three-way handshake) tamamlandıktan sonra, veri aktarımı başlar. Aktarım sırasında her segmente sıra numarası (sequence number) atanır ve pencere boyutu (window size) ile akış kontrolü sağlanır. Büyük veriler, segmentler halinde parçalara ayrılarak iletilir ve kayıp segmentler yeniden gönderilir (retransmission).

**Örnek senaryolar**

- **TCP ile büyük dosya indirme:**
HTTP ile 1 GB’lık bir dosya indirilirken veri TCP segmentlerine bölünerek gönderilir. Her segment, sequence number (sıra numarası) ile etiketlenir (ör. Seq=1, Seq=2, ...). Alıcı taraf bu numaralar sayesinde eksik veya kayıp segmentleri tespit eder ve gerekirse yeniden gönderilmesini ister (retransmission). Bu nedenle TCP, verinin eksiksiz ve doğru sırada iletilmesini sağlar. Örneğimize göre, 1 GB dosya her biri yaklaşık 1460 bayt olan ~735K segment halinde gönderilmesi sağlanır.

- **UDP ile canlı yayın (radyo / TV):**
Canlı yayınlarda çoğunlukla UDP kullanılır. Çünkü düşük gecikme önemlidir ve küçük paket kayıpları genellikle yayını ciddi şekilde bozmaz. UDP’de yeniden iletim olmadığı için veri daha hızlı ve kesintisiz iletilir.

![İletişim Komikleri](images/B03-iletisim_komik.png)
*Görsel kaynağı: [https://www.pinterest.com/pin/808536939357862630/](https://www.pinterest.com/pin/808536939357862630/)*

![TCP ve UDP başlıkları](images/B03-TCPveUDP-Baslik.png)
*Görsel kaynağı: [https://www.softwaretestinghelp.com/tcp-vs-udp/](https://www.softwaretestinghelp.com/tcp-vs-udp/)*
...
Uygulama programları genellikle 7. katmanda çalışmakta ve genellikle doğrudan 4. katman ile iletişime geçmektedir. Oturum ve sunum gibi işlemler yapılacaksa da genellikle uygulama içerisinde yapılıp 4. katmana aktarılmaktadır.
...
*Görsel kaynağı: [https://www.researchgate.net/publication/346192126_Requirements_for_cybersecurity_in_agricultural_communication_networks/](https://www.researchgate.net/publication/346192126_Requirements_for_cybersecurity_in_agricultural_communication_networks/)*

### Bilgi güvenliğinin temel unsurları

![CIA üçgeni](images/B03-CIA_Ucgeni.jpg){width="400"}
*CIA üçgeni. Görsel kaynağı: [https://fikirjeneratoru.com/bilgi-guvenligi-ve-bilgi-guvenligi-unsurlari/](https://fikirjeneratoru.com/bilgi-guvenligi-ve-bilgi-guvenligi-unsurlari/)*

![McCumber Küpü](images/B03-McCumber_Küpü.png)
*McCumber Küpü. Görsel kaynağı:  [https://fikirjeneratoru.com/bilgi-guvenligi-ve-bilgi-guvenligi-unsurlari/](https://fikirjeneratoru.com/bilgi-guvenligi-ve-bilgi-guvenligi-unsurlari/)*
